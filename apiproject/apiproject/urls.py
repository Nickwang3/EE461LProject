...
urlpatterns = [
    ...
    path('api/v1/games/game_id/<str:game_id>/prediction/<str:team_side>', views.post_prediction, name="post_prediction"),
    path('api/v1/games/away_team/<str:away_team>/home_team/<str:home_team>',views.get_games_by_teams_and_date, name="get_games_by_teams_and_date")
